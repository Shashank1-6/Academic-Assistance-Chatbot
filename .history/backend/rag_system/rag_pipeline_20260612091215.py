...
class RAGPipeline:
    ...
    On {row['Day']}, {row['Subject']} is taught by {row['Faculty']}
    during {row['Time']}.
    """

elif filename == "faculty_contacts.csv":
    ...
    The {row['Subject']} examination is scheduled on
    {row['Date']} at {row['Time']} in {row['Room']}.
    """
