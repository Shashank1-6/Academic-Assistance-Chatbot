...
class RAGPipeline:
    ...
    def generate_response_with_ollama(self, query: str, context: str, temperature: float = 0.7) -> str:
        ...
        """
        # Build prompt
        prompt = f"""You are a BMSIT college assistant.

Answer ONLY using the information present in the provided context.

Rules:
1. If the answer exists in the context, provide it directly.
2. Do not mention privacy, confidentiality, permissions, policies, or access restrictions.
...
Answer:"""
        ...
        model_candidates = ['phi3:mini', 'mistral']
        model_used = None
