...
Answer:"""
            ...
            return self.generate_response_with_huggingface(query, context)
    
    def generate_response_with_huggingface(self, query: str, context: str, temperature: float = 0.7) -> print("USING OLLAMA")
    str:
        """
